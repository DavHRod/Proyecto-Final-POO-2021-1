...
class plan:
    ...
    def crear(self,con):
        ...
        while True:
            ...
            self.fechaInicio=str(day)+"/"+str(month)+"/"+str(year)
            if comprobarFecha(self.fechaInicio) == "Mayor":
                break
            else:
        ...
        #Ingreso de edad mínima y máxima para aplicar al plan
        while True:
            while True:
                try:
    ...
    def cerrarPlanVacunacion(self,con):
        cursorObj = con.cursor()
    #Ingreso de un id para asignarlo a un plan
        self.idPlan=input("Ingrese el consecutivo del plan de vacunación: ")
        longMax = 20
